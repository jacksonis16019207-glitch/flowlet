...
description: flowlet に新しいタスクや改善案を追加するときに使う project-local Skill。思いついた要望を、課題、依存、優先度、完了条件つきの実行可能なタスクへ整理し、`docs/execution-task-list.md` や関連ドキュメントへ反映したいときに使う。既存タスクとの優先順位調整、Backlog 判定、P1/P2/P3 の振り分けをしたいときにも使う。
---
...
`Start.md` と `docs/execution-task-list.md` を基準に、追加候補を実行可能な単位へ落とし込む。

## Workflow

1. 前提を確認する
- `Start.md`、`AGENTS.md`、`docs/execution-task-list.md` を確認する。
- 必要に応じて `docs/requirements.md`、関連設計メモ、現在の未完了タスクを確認する。
...
5. 記録先を決める
- すぐ着手するものは [docs/execution-task-list.md](/C:/Users/jacks/Documents/flowlet/docs/execution-task-list.md) に追加する。
...
- 詳細な運用例や補足は [docs/task-addition-workflow.md](/C:/Users/jacks/Documents/flowlet/docs/task-addition-workflow.md) を参照する。
